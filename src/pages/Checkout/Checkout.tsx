  ...
  return (
    <Container>
      <div className="left-blocks">
        ...
        <Installments>
          <BlockHeader>
            <CurrencyDollar size={22} color="#b8d4e3" />
            <div className="block-text">
          ...
          <div className="installments-options">
            ...
            >
              <CreditCard size={16} color="EEFFDB" />
              Cartão de crédito
            </InstallmentButton>
            <InstallmentButton
      ...
      <div className="right-blocks">
        <SubTitle>Itens selecionados</SubTitle>
        <OrderSummary>
          <ul className="product-list" ref={parent}>
            {productsList.length === 0 ? (
              <>
                ...
                <EmptyCartButton href="/">Escolher meus itens</EmptyCartButton>
              </>
            ) : (
